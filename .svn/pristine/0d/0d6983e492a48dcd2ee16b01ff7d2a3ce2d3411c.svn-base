...
namespace LogSystemTutorial.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected class UserEntityStaticMetaData : EntityStaticMetaDataBase
		{
			...
			{
				SetEntityCoreInfo("UserEntity", InheritanceHierarchyType.None, false, (int)LogSystemTutorial.EntityType.UserEntity, typeof(UserEntity), typeof(UserEntityFactory), false);
				AddNavigatorMetaData<UserEntity, EntityCollection<EntryEntity>>("Entries", a => a._entries, (a, b) => a._entries = b, a => a.Entries, () => new UserRelations().EntryEntityUsingUserId, typeof(EntryEntity), (int)LogSystemTutorial.EntityType.EntryEntity);
			}
		}
		...
		public virtual EntityCollection<EntryEntity> Entries { get { return GetOrCreateEntityCollection<EntryEntity, EntryEntityFactory>("User", true, false, ref _entries); } }
...
namespace LogSystemTutorial.RelationClasses
{
	...
	{
		/// <summary>Returns a new IEntityRelation object, between UserEntity and EntryEntity over the 1:n relation they have, using the relation between the fields: User.Id - Entry.UserId</summary>
		public virtual IEntityRelation EntryEntityUsingUserId
		{
			get { return ModelInfoProviderSingleton.GetInstance().CreateRelation(RelationType.OneToMany, "Entries", true, new[] { UserFields.Id, EntryFields.UserId }); }
		}
	...
	{
		internal static readonly IEntityRelation EntryEntityUsingUserIdStatic = new UserRelations().EntryEntityUsingUserId;
