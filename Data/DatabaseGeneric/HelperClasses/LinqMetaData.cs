...
namespace LogSystemTutorial.Linq
{
	...
	public partial class LinqMetaData: ILinqMetaData
	{
		...
		{
			switch((LogSystemTutorial.EntityType)typeOfEntity)
			{
		...
		/// <summary>returns the datasource to use in a Linq query when targeting EntryEntity instances in the database.</summary>
		public DataSource2<EntryEntity> Entry {	get { return new DataSource2<EntryEntity>(this.AdapterToUse, new ElementCreator(), this.CustomFunctionMappings, this.ContextToUse); } }
