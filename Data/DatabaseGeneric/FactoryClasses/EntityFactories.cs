...
namespace LogSystemTutorial.FactoryClasses
{
	...
	{
		private readonly LogSystemTutorial.EntityType _typeOfEntity;
		...
		public EntityFactoryBase2(string entityName, LogSystemTutorial.EntityType typeOfEntity, bool isInHierarchy) : base(entityName)
		{
		...
		/// <inheritdoc/>
		public override IEntity2 CreateEntityFromEntityTypeValue(int entityTypeValue) {	return GeneralEntityFactory.Create((LogSystemTutorial.EntityType)entityTypeValue); }
	...
	/// <summary>Factory to create new, empty EntryEntity objects.</summary>
	[Serializable]
	public partial class EntryEntityFactory : EntityFactoryBase2<EntryEntity> 
	{
		/// <summary>CTor</summary>
		public EntryEntityFactory() : base("EntryEntity", LogSystemTutorial.EntityType.EntryEntity, false) { }
		/// <inheritdoc/>
		protected override IEntity2 CreateImpl(IEntityFields2 fields) { return new EntryEntity(fields); }
	}
	...
	{
		/// <summary>CTor</summary>
		public ProjectEntityFactory() : base("ProjectEntity", LogSystemTutorial.EntityType.ProjectEntity, false) { }
		/// <inheritdoc/>
	...
	{
		/// <summary>CTor</summary>
		public UserEntityFactory() : base("UserEntity", LogSystemTutorial.EntityType.UserEntity, false) { }
		/// <inheritdoc/>
	...
	{
		/// <summary>CTor</summary>
		public VersionInfoEntityFactory() : base("VersionInfoEntity", LogSystemTutorial.EntityType.VersionInfoEntity, false) { }
		/// <inheritdoc/>
	...
	public partial class GeneralEntityFactory
	{
		...
		public static IEntity2 Create(LogSystemTutorial.EntityType entityTypeToCreate)
		{
	...
	public static class EntityFactoryFactory
	{
		...
		{
			foreach(int entityTypeValue in Enum.GetValues(typeof(LogSystemTutorial.EntityType)))
			{
				var factory = GetFactory((LogSystemTutorial.EntityType)entityTypeValue);
		...
		/// <summary>Gets the factory of the entity with the LogSystemTutorial.EntityType specified</summary>
		/// <param name="typeOfEntity">The type of entity.</param>
		/// <returns>factory to use or null if not found</returns>
		public static IEntityFactory2 GetFactory(LogSystemTutorial.EntityType typeOfEntity)
		{
			switch(typeOfEntity)
			{
				case LogSystemTutorial.EntityType.EntryEntity:
					return new EntryEntityFactory();
				case LogSystemTutorial.EntityType.ProjectEntity:
					return new ProjectEntityFactory();
				case LogSystemTutorial.EntityType.UserEntity:
					return new UserEntityFactory();
				case LogSystemTutorial.EntityType.VersionInfoEntity:
	...
	{
		/// <summary>Gets the factory of the Entity type with the LogSystemTutorial.EntityType value passed in</summary>
		...
		{
			return new DynamicRelation(leftOperand, joinType, (LogSystemTutorial.EntityType)Enum.Parse(typeof(LogSystemTutorial.EntityType), rightOperandEntityName, false), aliasRightOperand, onClause);
		}

		/// <inheritdoc/>
		public override IDynamicRelation CreateDynamicRelation(string leftOperandEntityName, JoinHint joinType, string rightOperandEntityName, string aliasLeftOperand, string aliasRightOperand, IPredicate onClause)
		{
			return new DynamicRelation((LogSystemTutorial.EntityType)Enum.Parse(typeof(LogSystemTutorial.EntityType), leftOperandEntityName, false), joinType, (LogSystemTutorial.EntityType)Enum.Parse(typeof(LogSystemTutorial.EntityType), rightOperandEntityName, false), aliasLeftOperand, aliasRightOperand, onClause);
		}
		
		/// <inheritdoc/>
		public override IDynamicRelation CreateDynamicRelation(IEntityFieldCore leftOperand, JoinHint joinType, string rightOperandEntityName, string aliasLeftOperand, string aliasRightOperand, IPredicate onClause)
		{
			return new DynamicRelation(leftOperand, joinType, (LogSystemTutorial.EntityType)Enum.Parse(typeof(LogSystemTutorial.EntityType), rightOperandEntityName, false), aliasLeftOperand, aliasRightOperand, onClause);
		}
		
		/// <inheritdoc/>
		protected override IEntityFactoryCore GetFactoryImpl(int entityTypeValue) { return EntityFactoryFactory.GetFactory((LogSystemTutorial.EntityType)entityTypeValue); }
